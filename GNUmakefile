...
install-headers-gtkdgl: gtkdgl-$(MAJOR).pc install-headers-gtkd
	...
	install -m 644 gtkdgl-$(MAJOR).pc $(DESTDIR)$(prefix)/$(libdatadir)/pkgconfig
...
install-headers-gtkdsv: gtkdsv-$(MAJOR).pc install-headers-gtkd
	...
	install -m 644 gtkdsv-$(MAJOR).pc $(DESTDIR)$(prefix)/$(libdatadir)/pkgconfig
...
install-headers-gstreamer: gstreamerd-$(MAJOR).pc install-headers-gtkd
	...
	install -m 644 gstreamerd-$(MAJOR).pc $(DESTDIR)$(prefix)/$(libdatadir)/pkgconfig
...
install-headers-vte: vted-$(MAJOR).pc install-headers-gtkd
	...
	install -m 644 vted-$(MAJOR).pc $(DESTDIR)$(prefix)/$(libdatadir)/pkgconfig
...
install-headers-peas: peasd-$(MAJOR).pc install-headers-gtkd
	...
	install -m 644 peasd-$(MAJOR).pc $(DESTDIR)$(prefix)/$(libdatadir)/pkgconfig
...
uninstall: uninstall-gtkdgl uninstall-gtkdsv uninstall-gstreamer uninstall-vte uninstall-peas
	...
	rm -f $(DESTDIR)$(prefix)/$(libdatadir)/pkgconfig/gtkd-$(MAJOR).pc
...
uninstall-gtkdgl:
	...
	rm -f $(DESTDIR)$(prefix)/$(libdatadir)/pkgconfig/gtkdgl-$(MAJOR).pc
...
uninstall-gtkdsv:
	...
	rm -f $(DESTDIR)$(prefix)/$(libdatadir)/pkgconfig/gtkdsv-$(MAJOR).pc
...
uninstall-gstreamer:
	...
	rm -f $(DESTDIR)$(prefix)/$(libdatadir)/pkgconfig/gstreamerd-$(MAJOR).pc
...
uninstall-vte:
	...
	rm -f $(DESTDIR)$(prefix)/$(libdatadir)/pkgconfig/vted-$(MAJOR).pc
...
uninstall-peas:
	...
	rm -f $(DESTDIR)$(prefix)/$(libdatadir)/pkgconfig/peasd-$(MAJOR).pc
